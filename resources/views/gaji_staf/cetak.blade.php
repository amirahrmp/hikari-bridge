...
<br>
        <table width="100%" class="table table-bordered table-striped">
            ...
            @forelse($items as $item)
                <tr>
                    ...
                    @php 
                        ...
                        $totalKeseluruhanGaji += $total_gaji;
                    @endphp
            ...
            @if(!empty($items))
                <tfoot>
                    <tr>
                        <td colspan="9" class="text-right"><strong>Total Keseluruhan Gaji:</strong></td>
                        <td><strong>Rp. {{ number_format($totalKeseluruhanGaji, 0, '', '.') }}</strong></td>
                    </tr>
                </tfoot>
            @endif
        </table>
<br></br>
        <table width="100%">
            <tr>
                <td></td>
                <td width="200px">
                    <p>Bandung, {{ date("d M Y") }} <br /> Sambel Jerit</p>
                    <br/>
                    <br/>
