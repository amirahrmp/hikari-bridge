...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
    <h5 class="mb-0" ><strong>Laporan Pendapatan</strong></h5>
    <span class="text-secondary">Dashboard <i class="fa fa-angle-right"></i> Laporan <i class="fa fa-angle-right"></i> Laporan Pendapatan</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form action="{{ route('reports.revenue') }}" method="get" class="mb-5">
                                <div class="row">
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mx-sm-3 mb-2">
                                            <button type="submit" class="btn btn-primary btn-danger">Cetak</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
