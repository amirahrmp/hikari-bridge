...
@section('pengasuh_select','active')
@section('title', 'Tenaga Pengasuh')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tenaga Pengasuh</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body p-0">
                                        <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#addTenagaPengasuhModal">
                                            ...
                                            <table id="datatable" class="table table-bordered table-striped">
                                                ...
                                                @foreach($pengasuh as $p)
                                                    <tr>
                                                        <td>{{ $p->id_card }}</td>
                                                        <td>{{ $p->nik }}</td>
                                                        <td>{{ $p->nama_pengasuh }}</td>
                                                        <td>{{ $p->tipe_pengasuh }}</td>
                                                        <td>{{ $p->jk }}</td>
                                                        <td>{{ $p->telp }}</td>
                                                        <td>{{ $p->email }}</td>
                                                        <td>{{ $p->tmp_lahir }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button href="{{ URL::to('delete-pengasuh/'.$p->id) }}" class="btn-sm btn-danger" id="delete">
                                                        ...
                                                        <div class="modal-dialog modal-default">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="editModalLabel{{ $p->id }}">Ubah Data Tenaga Pengasuh</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <form action="{{ route('pengasuh.update', $p->id) }}" method="post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="nama_pengasuh" class="form-label">Nama:</label>
                                                                            <input type="text" class="form-control @error('nama_pengasuh') is-invalid @enderror" id="nama_pengasuh" name="nama_pengasuh" value="{{ old('nama_pengasuh', $p->nama_pengasuh) }}" maxlength="50" required>
                                                                            @error('nama_pengasuh')
                                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="tipe_pengasuh" class="form-label">Tipe Pengasuh:</label>
                                                                            <input type="text" class="form-control @error('tipe_pengasuh') is-invalid @enderror" id="tipe_pengasuh" name="tipe_pengasuh" value="{{ old('tipe_pengasuh', $p->tipe_pengasuh) }}" maxlength="50" required>
                                                                            @error('tipe_pengasuh')
                                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                        ...
                                        <!-- Modal Tambah Data -->
                                        <div class="modal fade" id="addTenagaPengasuhModal" tabindex="-1" aria-labelledby="addTenagaPengasuhModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-default">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="addTenagaPengasuhModalLabel">Tambah Data Tenaga Pengasuh</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="{{ route('pengasuh.store') }}" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nama_pengasuh" class="form-label">Nama:</label>
                                                                <input type="text" class="form-control @error('nama_pengasuh') is-invalid @enderror" id="nama_pengasuh" name="nama_pengasuh" maxlength="50" required>
                                                                @error('nama_pengasuh')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="tipe_pengasuh" class="form-label">Tipe Pengasuh:</label>
                                                                <input type="text" class="form-control @error('tipe_pengasuh') is-invalid @enderror" id="tipe_pengasuh" name="tipe_pengasuh" maxlength="50" required>
                                                                @error('tipe_pengasuh')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                        ...
                                        <div class="modal fade" id="uploadExcelModal" tabindex="-1" role="dialog" aria-labelledby="uploadExcelModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="uploadExcelModalLabel">Impor Data Tenaga Pengasuh dari Excel</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ route('pengasuh.upload') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
