            ...
            <h5 class="card-title fw-semibold mb-4">Data Customer</h5>
                ...
                <form action="{{ route('customer.update', $customer->id) }}" method="post">
                    ...
                    <fieldset disabled>
                        ...
                        <input class="form-control form-control-solid" id="nomor-customer_tampil" name="nomor_customer_tampil" type="text" placeholder="Contoh: CS-001" value="{{$customer->nomor_customer}}" readonly></div>
                    </fieldset>
                    <input type="hidden" id="nomor_customer" name="nomor_customer" value="{{$customer->nomor_customer}}">
                    ...
                    <div class="mb-0"><label for="nomortelplabel">Nomor Telp</label>
                        <textarea class="form-control form-control-solid" id="nomor_telp" name="nomor_telp" rows="3" placeholder="Cth: 088876548910">{{old('nomor_telpon')}}</textarea>
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
