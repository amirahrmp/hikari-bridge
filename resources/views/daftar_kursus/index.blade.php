        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('registerkidzdaycare.create') }}" class="btn btn-primary mt-3">Daftar Kursus</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('registerkidzclub.create') }}" class="btn btn-primary mt-3">Daftar Kursus</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('registerquran.create') }}" class="btn btn-primary mt-3">Daftar Kursus</a>
                </div>
            </div>
        </div>
    </div>
