                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <a href="{{ route('potongan-gaji.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> </a>
                            </div><!-- /.col --> 
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach($potongan_gaji as $pg)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('potongan-gaji.edit', $pg->id) }}" class="btn btn-info"> <i class="fa fa-edit"></i> </a>
                                                            <form onclick="return confirm('anda yakin ? ');" class="d-inline-block" action="{{ route('potongan-gaji.destroy', $pg->id) }}" method="post">
                                                                @csrf 
                                                                @method('delete')
