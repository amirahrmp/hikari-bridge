...
<div class="container mt-5 mb-5">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-success text-white py-3">
            <h2 class="mb-0 text-center">Formulir Pembayaran SPP</h2>
        </div>
        <div class="card-body p-4">
            ...
            {{-- Data Peserta & Tagihan SPP --}}
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0"><i class="fas fa-info-circle me-2"></i>Informasi Tagihan SPP</h5>
                </div>
                <div class="card-body bg-white text-dark">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="mb-0"><strong>Periode SPP:</strong> <span class="fw-normal">{{ \Carbon\Carbon::create()->month($tagihan->bulan)->format('F') }} {{ $tagihan->tahun }}</span></p>
                            <p class="mb-0"><strong>Nominal SPP:</strong> <span class="fw-normal">Rp{{ number_format($tagihan->nominal_uang_spp, 0, ',', '.') }}</span></p>
            ...
            <form method="POST" action="{{ route('spp.customer.proses_pembayaran', $tagihan->id) }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <ul class="list-group list-group-flush">
                                    @foreach($komponenList as $komponenNama => $nominal)
                                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-0">
                                        ...
                                        <input type="hidden" name="komponen[]" value="{{ $komponenNama }}">
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                ...
                {{-- Payment Instructions, Upload, and Save Button --}}
...
<script>
    ...
    const tagihanNominalSpp = {{ $tagihan->nominal_uang_spp }}; // Get the nominal directly from the passed $tagihan object
    ...
    function hitungJumlah() {
        // For SPP Bill, the total is simply the tagihan nominal
        let total = tagihanNominalSpp;
