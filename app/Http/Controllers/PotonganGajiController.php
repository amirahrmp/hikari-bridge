...
use App\Http\Requests\PotonganGajiRequest;
...
class PotonganGajiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('potongan-gaji.index', compact('potongan_gaji'));
    }
    ...
    {
        return view('potongan-gaji.create');
    }
    ...
    public function store(PotonganGajiRequest $request)
    {
        ...
        return redirect()->route('potongan-gaji.index')->with([
    ...
    {
        return view('potongan-gaji.edit', compact('potongan_gaji'));
    }
